...
3. [PortSwigger: XSS](https://portswigger.net/web-security/cross-site-scripting)
4. [PortSwigger: Blind SQL Injection](https://portswigger.net/web-security/sql-injection/blind)
5. [PortSwigger: Content Security Policy](https://portswigger.net/web-security/cross-site-scripting/content-security-policy#mitigating-xss-attacks-using-csp)
6. [PortSwigger: Insecure Deserialization](https://portswigger.net/web-security/deserialization)
7. [PortSwigger: Web cache poisoning](https://portswigger.net/web-security/web-cache-poisoning)
8. [PortSwigger: SSRF (Server-side request forgery)](https://portswigger.net/web-security/ssrf)
9. [PortSwigger: SQL Injection](https://portswigger.net/web-security/sql-injection)
10. [PortSwigger: CSRF (Cross-site request forgery)](https://portswigger.net/web-security/csrf)
11. [OWASP: SQL Injection Prevention](https://cheatsheetseries.owasp.org/cheatsheets/SQL_Injection_Prevention_Cheat_Sheet.html)
12. [Acunetix: CRLF Injection Attacks](https://www.acunetix.com/websitesecurity/crlf-injection/)
13. [PortSwigger: Insecure direct object references (IDOR)](https://portswigger.net/web-security/access-control/idor)
14. [PortSwigger: HTTP request smuggling](https://portswigger.net/web-security/request-smuggling)
15. [PortSwigger: Same-origin policy (SOP)](https://portswigger.net/web-security/cors/same-origin-policy)
16. [PortSwigger: CSRF tokens](https://portswigger.net/web-security/csrf/tokens)
17. [PortSwigger: Defending against CSRF with SameSite cookies](https://portswigger.net/web-security/csrf/samesite-cookies)
18. [PortSwigger: XXE (XML external entity) injection](https://portswigger.net/web-security/xxe)
19. [PortSwigger: Dangling markup injection](https://portswigger.net/web-security/cross-site-scripting/dangling-markup)
