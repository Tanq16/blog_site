...
categories: [Lab Practice Notes, FLAWS Labs]
tags: [aws,policies,iam,lambda,s3,security,flaws,lab]
---
...
This gives a secret &rarr; `access_keys.txt:1:AKIAJ366LIPB4IJKT7SA` and `access_keys.txt:2:secret_access_key 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` 
